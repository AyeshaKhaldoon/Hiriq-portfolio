    ...
    <footer className="relative bg-gradient-to-r from-blue-900 via-cyan-900 to-sky-900 text-white pt-8 pb-4 z-10 shadow-inner overflow-x-hidden">
      <div className="max-w-7xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            {showSocialIcons && (
              <div className="flex gap-4 mt-6">
                <a href="https://www.linkedin.com/company/hiriq" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center transition-colors" aria-label="LinkedIn">
        ...
        <div className="border-t border-cyan-600 pt-4 text-center text-sm text-gray-400 pb-safe">
          ...
          <p className="m-0 mt-1">Last updated: August 22, 2026</p>
        </div>
      </div>
    </footer>
  );
