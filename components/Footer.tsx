...
export default function Footer({ showSocialIcons = false }: FooterProps) {
  return (
    <footer className="relative bg-gradient-to-r from-blue-900 via-cyan-900 to-sky-900 text-white pt-8 pb-4 z-10 shadow-inner">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            {/* Social Icons - Only shown on homepage */}
            {showSocialIcons && (
            ...
            {/* Smark Technologies Branding */}
            <div className="mt-6">
              <p className="text-sm text-gray-400">
                Developed by{' '}
                <a 
                  href="https://smarktechs.com" 
                  target="_blank" 
                  rel="noopener noreferrer"
        ...
        <div className="border-t border-cyan-600 pt-4 text-center text-sm text-gray-400">
