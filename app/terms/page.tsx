        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-600 mb-4">
                <strong>Security Breach Notification:</strong> If you suspect unauthorized access to your account, contact us immediately at security@hiriq.com. We will investigate and take appropriate action within 24 hours.
              </p>
            </section>
