  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 overflow-hidden">
      ...
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-24 left-1/4 w-[600px] h-[600px] bg-gradient-to-br from-blue-400/40 to-purple-400/40 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute -bottom-24 right-1/4 w-[600px] h-[600px] bg-gradient-to-br from-purple-400/40 to-pink-400/40 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-br from-pink-400/30 to-blue-400/30 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>

      {/* Navigation */}
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white/95 backdrop-blur-xl border-b border-purple-200/50 shadow-lg shadow-purple-500/5' : 'bg-white/80 backdrop-blur-md'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <Link href="/" className="flex items-center group cursor-pointer">
              <div className="relative">
                <Sparkles className="w-7 h-7 text-purple-500 absolute -top-1 -left-1 animate-pulse" />
                <span className="text-3xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent ml-6">
                  Hiriq
                </span>
              </div>
            </Link>
            ...
            <div className="hidden md:flex items-center space-x-8">
              <Link href="/for-recruiters" className="text-slate-700 hover:text-purple-600 transition-colors duration-200 font-medium">
                For Recruiters
              </Link>
              ...
              <button className="px-4 py-2 text-slate-700 hover:text-purple-600 transition-colors duration-200 font-medium">
                Sign In
              </button>
              <button className="px-6 py-3 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white rounded-xl font-semibold hover:shadow-lg hover:shadow-purple-500/50 transition-all duration-300 transform hover:scale-105">
                Start Free Trial
              </button>
            </div>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden pb-6 space-y-4">
              ...
              <button className="block w-full text-left px-4 py-2 text-slate-700 hover:text-purple-600 transition-colors duration-200 font-medium">
                Sign In
              </button>
              <button className="block w-full px-6 py-3 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white rounded-xl font-semibold">
                Start Free Trial
              </button>
            </div>
          )}
      ...
      <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 z-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center px-5 py-2 bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 border border-purple-200 rounded-full mb-8 backdrop-blur-sm shadow-lg">
              <Zap className="w-4 h-4 text-purple-600 mr-2 animate-pulse" />
              <span className="text-sm font-semibold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">AI-Powered Recruitment Platform</span>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto mb-20">
              ...
              {/* Candidate Card */}
              <div className="group relative">
                <div className="absolute inset-0 bg-gradient-to-br from-purple-400 to-pink-600 rounded-2xl blur-xl opacity-30 group-hover:opacity-50 transition-opacity duration-300"></div>
                <Link href="/for-candidates" className="block">
                  <div className="relative bg-white/90 backdrop-blur-xl p-8 rounded-2xl border-2 border-purple-200 hover:border-purple-400 transition-all duration-300 transform hover:scale-105 hover:-translate-y-2 shadow-xl hover:shadow-2xl">
                    <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mb-6 group-hover:rotate-6 transition-transform duration-300 shadow-lg">
      ...
      <section className="relative py-20 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            {/* Stat 1 */}
            <div className="group relative">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-400 to-purple-500 rounded-2xl blur-xl opacity-20 group-hover:opacity-30 transition-opacity duration-300"></div>
            ...
            {/* Stat 2 */}
            <div className="group relative">
              <div className="absolute inset-0 bg-gradient-to-br from-purple-400 to-pink-500 rounded-2xl blur-xl opacity-20 group-hover:opacity-30 transition-opacity duration-300"></div>
              <div className="relative bg-white/80 backdrop-blur-xl border-2 border-purple-200 p-8 rounded-2xl transform hover:-translate-y-2 transition-all duration-300 shadow-xl hover:shadow-2xl hover:border-purple-300">
                <div className="flex items-center justify-center mb-4">
                  <CheckCircle className="w-12 h-12 text-purple-600 mr-3 animate-pulse" style={{ animationDelay: '0.5s' }} />
            ...
            {[
              ...
              <div key={index} className="flex-shrink-0 w-96 mx-4">
                <div className="group relative h-full">
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-400 to-purple-500 rounded-2xl blur-xl opacity-10 group-hover:opacity-20 transition-opacity duration-300"></div>
                  <div className="relative bg-white/80 backdrop-blur-xl border-2 border-purple-200 hover:border-purple-300 p-6 rounded-2xl transition-all duration-300 shadow-lg hover:shadow-xl h-full flex flex-col">
      ...
      <section className="relative py-24 z-10">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="group relative px-8 py-4 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white rounded-xl font-semibold overflow-hidden transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl">
              <span className="relative flex items-center justify-center">
                Start Free Trial
                <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" />
              </span>
            </button>
            <button className="px-8 py-4 bg-white/80 backdrop-blur-xl border-2 border-purple-300 text-slate-900 rounded-xl font-semibold hover:bg-white hover:border-purple-400 transition-all duration-300 transform hover:scale-105 shadow-lg">
              Schedule a Demo
            </button>
          </div>
        </div>
      ...
      {/* Footer */}
{/* Footer */}
<footer className="relative bg-gradient-to-r from-purple-900 via-purple-800 to-purple-700 text-white py-16 z-10 shadow-inner">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="grid md:grid-cols-4 gap-8 mb-12">
      ...
      <div>
        ...
        <ul className="space-y-2 text-gray-300 text-sm">
          <li><Link href="/for-recruiters" className="hover:text-yellow-400 transition-colors">For Recruiters</Link></li>
    ...
    <div className="border-t border-purple-600 pt-8 text-center text-sm text-gray-400">
