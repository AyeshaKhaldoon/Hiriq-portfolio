...
export default function ForCandidates() {
  ...
  const handleSubscribe = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        setStatus('success');
        setMessage('🎉 Thanks for joining the waitlist! Check your inbox for updates.');
        setEmail('');
      } else {
        setStatus('error');
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/for-candidates" className="text-purple-600 font-semibold">For Candidates</Link>
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-purple-50 via-white to-blue-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center px-6 py-3 bg-purple-600 text-white rounded-full mb-6 animate-pulse">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <button
                    ...
                    className="px-8 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition font-semibold whitespace-nowrap"
                  >
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 border-2 border-purple-200">
            ...
            <div className="mt-10 text-center">
              <Link href="/for-candidates">
                <button className="px-8 py-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg font-semibold hover:shadow-xl transition-all text-lg inline-flex items-center gap-2">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <form onSubmit={handleSubscribe} className="max-w-md mx-auto flex gap-3">
            ...
            <button
              type="submit"
              disabled={status === 'loading'}
              className="px-8 py-4 bg-white text-purple-600 rounded-lg font-semibold hover:bg-purple-50 transition whitespace-nowrap"
            >
              {status === 'loading' ? 'Joining...' : 'Join Waitlist'}
            </button>
          </form>
